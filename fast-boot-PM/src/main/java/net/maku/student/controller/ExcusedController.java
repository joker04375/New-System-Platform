...
public class ExcusedController {
    ...
    public Result selectStuExcused(){
        List<SysStuExcusedEntity> sysStuExcusedEntities = sysStuExcusedService.selectExcuseds(SecurityUser.getUserId());
    ...
    public Result selectCollegeExcused(@PathVariable("id") Long timeId){
        List<SysStuExcusedEntity> sysStuExcusedEntities = sysStuExcusedService.selectCollegeExcusedsByColIdAndTimeId(SecurityUser.getUser().getOrgId(),timeId);
        return Result.ok(sysStuExcusedEntities);
    }
    ...
    public Result selectEnterpriseExcused(@PathVariable("id") Long pracId){
        List<SysStuExcusedEntity> sysStuExcusedEntities = sysStuExcusedService.selectEnterpriseExcusedsByOrgIdAndPracId(SecurityUser.getUser().getOrgId(),pracId);
        return Result.ok(sysStuExcusedEntities);
    }
