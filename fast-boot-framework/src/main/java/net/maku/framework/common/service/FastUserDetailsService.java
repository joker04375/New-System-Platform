...
//import net.maku.framework.common.convert.SysUserConvert;
//import net.maku.framework.common.dao.SysUserDao;
...
//        SysUserEntity userEntity = sysUserDao.getByWorkNumber(username);
//        if(userEntity == null) {
