...
import net.maku.auth.exception.FastAuthenticationException;
import net.maku.auth.handler.UserAuthenticationFailureHandler;
...
public class ValidateCodeFilter extends OncePerRequestFilter {
    private final static String OAUTH_TOKEN_URL = "/api/oauth/login";
    @Autowired
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        log.debug("进入ValidateCodeFilter过滤器");
